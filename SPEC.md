...
| Campo | Valor |
|---|---|
| Repositorio | `chat_service_project` |
| Linguagem | C++ (C++20 / CMake) |
| Versao | 1.0 |
| Status | Ativo |

## 1. Objetivo e escopo

Mensageria/chat em tempo real. Este documento descreve requisitos, arquitetura e criterios de aceite.
