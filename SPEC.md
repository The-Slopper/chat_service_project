# Especificacao Tecnica — Chat Service

| Field | Value |
|---|---|
| Repository | `chat_service_project` |
| Language | C++ (C++20 / CMake) |
| Versao | 1.0 |
| Status | Ativo |

## 1. Objective and escopo

Mensageria/chat in time real. This document describes requirements, architecture, and acceptance criteria.
